package app.example.Charts.ResizableChartWithinScrollPane;
...
public class ResizableChartWithinScrollPaneDemo extends Application {

	public ResizableChartWithinScrollPaneDemo() {
		Platform.runLater(() -> {
			try {
				start(new Stage());
			} catch (Exception e) {
