...
public class SVGToImageDemo extends Application {
	
	public SVGToImageDemo() {
		Platform.runLater(() -> {
			try {
				start(new Stage());
			} catch (Exception e) {
  ...
  public void start(Stage stage) throws Exception {
	...
	BufferedImage bufferedImage = SwingFXUtils.fromFXImage(wView.snapshot(null, null), null);
...
//		                       new File(getName(svg, fmt)));
    ...
    vBox.getChildren().setAll(txtB, imageView, hBox );
