package app.example.Color.ColorBeispiel;
...
{  
   ...
   private final TextField redField = new TextField("Red Value");
   private final TextField greenField = new TextField("Green Value");
   private final TextField blueField = new TextField("Blue Value");

   private final Rectangle customColorRectangle = new Rectangle();
 
   public JavaFX_ColorDemo() {
	   customColorRectangle.setWidth(COLOR_RECT_WIDTH);
	   customColorRectangle.setHeight(COLOR_RECT_HEIGHT);
	   customColorRectangle.setFill(Color.WHITE);
	   customColorRectangle.setStroke(Color.BLACK);	   
