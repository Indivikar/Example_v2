package app.example.Images.ZoomWithScrollAndMoveImage;
...
public class ZoomAndPanDemo extends Application {

	private String IMAGE_URL = "https://www.map-sales.de/media/catalog/product/cache/2/image/8ecabcfb697832bc77ac7e2547ded39f/1/1/110057_europa.jpg";
    ...
    public void start(Stage primaryStage) {
        ...
        Label label = new Label("Drag Image = Hold down the left mouse button | Reset Zoom = Double click left mouse button | Fit Width = Double click right mouse button");
