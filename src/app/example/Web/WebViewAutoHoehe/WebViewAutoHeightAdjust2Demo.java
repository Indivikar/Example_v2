package app.example.Web.WebViewAutoHoehe;
...
public class WebViewAutoHeightAdjust2Demo extends Application {
	...
	public WebViewAutoHeightAdjust2Demo() {
		Platform.runLater(() -> {           
	        try {
				start(new Stage());
			} catch (Exception e) {
	...
	public void start(Stage stage) throws Exception {
		...
		footer.setStyle("-fx-background-color:orange;");
