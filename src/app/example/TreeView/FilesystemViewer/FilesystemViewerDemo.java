package app.example.TreeView.FilesystemViewer;
...
// http://git.eclipse.org/c/efxclipse/org.eclipse.efxclipse.git/tree/bundles/runtime/org.eclipse.fx.ui.controls/src/org/eclipse/fx/ui/controls/filesystem

public class FilesystemViewerDemo extends Application {
 
  private static RootDirItem rootDirItem;
 
  public FilesystemViewerDemo() {
	  try {
			start(new Stage());
		} catch (Exception e) {
