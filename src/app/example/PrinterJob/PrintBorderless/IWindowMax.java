...
public interface IWindowMax {
	...
	public default void setWindowMaxIcon(Stage stage, Button buttonWindowMax, AnchorPane shadowPane, AnchorPane pane) {
...
//			buttonWindowMax.setStyle("-fx-graphic: url('/application/module/modulPR/view/images/Button-Max-false.png')");
		...
		// Wenn es keine shadowPane gibt oder sie gleich gross ist, wie die mainPane, dann hier abbrechen
		if (shadowPane == null || shadowPane.getWidth() == pane.getWidth()) {
			return;
		}
