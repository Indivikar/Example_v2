package app.example.Internationalization.ChangeLanguage;
...
//    }
    ...
    public void start(Stage primaryStage) {
        ...
        languageSelect.valueProperty().addListener((obs, oldValue, newValue) -> {
            if (newValue != null) {
            	System.out.println(RESOURCE_NAME + " - " + newValue);
    ...
    public static class Resources_de_DE extends ListResourceBundle {
        @Override
        protected Object[][] getContents() {
            return new Object[][] {
                    {"greeting", "Hallo"},
