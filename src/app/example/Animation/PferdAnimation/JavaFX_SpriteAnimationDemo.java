package app.example.Animation.PferdAnimation;
 ...
 */
public class JavaFX_SpriteAnimationDemo extends Application {

    private static final Image IMAGE = new Image(JavaFX_SpriteAnimationDemo.class.getResourceAsStream("The_Horse_in_Motion.jpg")); 
    ...
    public JavaFX_SpriteAnimationDemo() {
		Platform.runLater(() -> {           
	           start(new Stage());		       
		});
	}
