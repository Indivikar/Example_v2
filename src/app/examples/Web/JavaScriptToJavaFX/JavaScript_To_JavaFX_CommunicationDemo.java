package app.examples.Web.JavaScriptToJavaFX;
...
public class JavaScript_To_JavaFX_CommunicationDemo extends Application {
    ...
    public JavaScript_To_JavaFX_CommunicationDemo() {
		Platform.runLater(() -> {           
	           start(new Stage());		       
		});
	}
