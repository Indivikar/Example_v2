package app.examples.Bindings.ImageViewBinding;
...
public class ImageResizerDemo extends Application {
	
	public ImageResizerDemo() {
		Platform.runLater(() -> {           
	           start(new Stage());		       
		});
	}
    ...
    public void start(Stage primaryStage) {
        ...
        Image image = new Image(ImageResizerDemo.class.getResourceAsStream("javafx-documentation.png"));
